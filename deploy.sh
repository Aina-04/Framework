...
APP_NAME="frameworktsybrandysatriatsyobsédétsonyela"
SRC_DIR="src/main/java"
WEB_DIR="src/main/webapp"
BUILD_DIR="build"
LIB_DIR="lib"
TOMCAT_WEBAPPS="/home/lavi/apache-tomcat-10.0.16/webapps"
...
cp $BUILD_DIR/web.xml $BUILD_DIR/WEB-INF/web.xml
rm -f $BUILD_DIR/web.xml
